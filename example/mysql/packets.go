...
func (mc *mysqlConn) writePacket(data []byte) error {
	// fmt.Println("writePacket:", data)
	// fmt.Println("writePacket:", string(data))
	pktLen := len(data) - 4
	...
	for {
		...
		klog.Infof("---------- writePacket: ", data[:4+size])
		klog.Infof("---------- writePacket: %s", string(data[:4+size]))
...
func (mc *mysqlConn) readHandshakePacket() (data []byte, plugin string, err error) {
	...
	fmt.Println("readHandshakePacket", data, string(data))
	if err != nil {
...
func (mc *mysqlConn) writeAuthSwitchPacket(authData []byte) error {
	fmt.Println("writeAuthSwitchPacket")
...
func (mc *mysqlConn) writeCommandPacket(command byte) error {
	fmt.Println("writeCommandPacket")
...
func (mc *mysqlConn) writeCommandPacketStr(command byte, arg string) error {
	fmt.Println("writeCommandPacketStr")
	// Reset Packet Sequence
	mc.sequence = 0
...
func (mc *mysqlConn) writeCommandPacketUint32(command byte, arg uint32) error {
	fmt.Println("writeCommandPacketUint32")
	// Reset Packet Sequence
	mc.sequence = 0
...
func (mc *okHandler) readResultSetHeaderPacket() (int, error) {
	fmt.Println("readResultSetHeaderPacket")
...
func (stmt *mysqlStmt) writeExecutePacket(args []driver.Value) error {
	fmt.Println("writeExecutePacket", args)
